...
#ifndef tflite_learn_1904_GEN_H
#define tflite_learn_1904_GEN_H
...
TfLiteStatus tflite_learn_1904_reset( void (*free)(void* ptr) );


// Returns the number of input tensors.
inline size_t tflite_learn_1904_inputs() {
  return 1;
}
// Returns the number of output tensors.
inline size_t tflite_learn_1904_outputs() {
  return 1;
}
